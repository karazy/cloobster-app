Ext.define('EatSense.util.Translations',{
	statics: {
		...
		"checkInStep1Label1" : "Bitte wählen Sie einen Spitznamen.",
		...
		"account.logout.confirm.message" : "Möchten Sie ausloggen?",
		//history
		...
		"error.account.email" : "Bitte geben Sie eine gültige E-Mail an.",
