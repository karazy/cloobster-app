...
Ext.define('GT.override.FixedButton', {
    extend: 'Ext.Button',
    xtype: 'fixedbutton',  
    config: {
        /**
    ...
    onPress: function(e) {
        ...
        if (!me.getDisabled()) {
            ...
            var target = Ext.getCmp(me.pressedTarget) || me,
    ...
    // @private
    onRelease: function(e, element, notouch) {
        this.fireAction('release', [this, e, element, notouch], 'doRelease');
    },

    // @private
    doRelease: function(me, e, element, notouch) {
