Ext.define('EatSense.view.Privacy', {
	...
	config: {
		...
		'<br>'+
		'(1) Voraussetzung für die Nutzung der App ist die Zulassung durch die Firma Karazy GmbH. '+
		'<br><br>'+
		...
		'<b>3. Haftung</b>'+
		'<br>'+
		'(1) Die Firma Karazy GmbH haftet für Vorsatz und grobe Fahrlässigkeit uneingeschränkt. '+
		'<br><br>'+
		'(2) Für von der Firma Karazy GmbH nicht verschuldete Störungen innerhalb des Leitungsnetzes übernimmt die Firma Karazy GmbH keine Haftung.'+
		'<br><br>'+
		'(3) Für den Verlust von Daten haftet die Firma Karazy GmbH nach Maßgabe der vorstehenden Absätze nur dann, wenn ein solcher Verlust durch angemessene Datensicherungsmaßnahmen seitens des Kunden nicht vermeidbar gewesen wäre.'+
		'<br><br>'+
		'(4) Die Haftung erstreckt sich nicht auf Beeinträchtigungen des vertragsgemäßen Gebrauchs der von der Firma Karazy GmbH erbrachten Leistungen, die durch eine unsachgemäße oder fehlerhafte Inanspruchnahme durch den Kunden verursacht worden sind.'+
		'<br><br>'+
		'(5) Die vorstehenden Haftungsbeschränkungen gelten sinngemäß auch zugunsten der Erfüllungsgehilfen der Firma Karazy GmbH.'+
		'<br><br>'+
		'(6) Soweit über die Software/Applikation eine Möglichkeit der Weiterleitung auf Datenbanken, Websites, Dienste etc. Dritter, z.B. durch die Einstellung von Links oder Hyperlinks gegeben ist, haftet die Firma Karazy GmbH weder für Zugänglichkeit, Bestand oder Sicherheit dieser Datenbanken oder Dienste, noch für den Inhalt derselben. Insbesondere haftet die Firma Karazy GmbH nicht für deren Rechtmäßigkeit, inhaltliche Richtigkeit, Vollständigkeit, Aktualität, etc.'+
		'<br><br>'+
		...
		'<br><br>'+
		'(4) Der Kunde willigt darin ein, dass die Firma Karazy GmbH Informationen und Daten über Nutzungsverhalten in anonymisierter Form speichert und ausschließlich in dieser anonymisierten Form für Marketingzwecke, z. B. für die Erstellung von Statistiken und Präsentationen, nutzen darf.'+
		'<br><br>'+
		...
		'<br><br>'+
		'(2) Die Firma Karazy GmbH macht sich fremde Inhalte unter keinen Umständen zu Eigen und behält sich vor, fremde Inhalte zu sperren, wenn diese nach den geltenden Gesetzen strafbar sind oder erkennbar zur Vorbereitung strafbarer Handlungen dienen.'+
		'<br><br>'+
		'(3) Der Kunde wird die Firma Karazy GmbH von sämtlichen Ansprüchen freistellen, die Dritte gegen die Firma Karazy GmbH wegen der Verletzung ihrer Rechte oder wegen Rechtsverstößen aufgrund der vom Kunden eingestellten Angebote und/oder Inhalte geltend machen. Der Kunde übernimmt diesbezüglich auch die Kosten der Rechtsverteidigung von der Firma Karazy GmbH einschließlich sämtlicher Gerichts- und Anwaltskosten.'+
		'<br><br>'+
